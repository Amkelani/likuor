...
import {
    useGetOrdersQuery, useGetProductsQuery
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <text.T14>- R{section.discount}</text.T14>
                    </View>
                    <View
                        style={{
                            flexDirection: 'row',
                    ...
                    >
                        ...
                        <text.T14>R{section.delivery}</text.T14>
                    </View>
                </View>
                {section.status !== 'Delivered' && (
                    <components.Button
