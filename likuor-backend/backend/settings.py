...
secrets = get_secrets('likour_configurations')
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://192.168.0.104:8000",  # Your machine's IP
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'likour', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # OR 'rest_framework.authentication.TokenAuthentication',  # If using DRF Token auth
    ],
...
AWS_STORAGE_BUCKET_NAME = secrets['static_styles_s3']
